...
import CopyLink from '~/playground/CopyLink';
import Selector from '~/playground/Selector';
...
export default function Header({
    ...
    const onShare = useCallback(() => {
        ...
        try {
            ...
            setShareURL(`/${pathname}#${hash}`);
        } catch (error) {
            setShareURL(null);
            console.error(error);
        }
    }, [formData, liveSettings, schema, theme, uiSchema, setShareURL, location, navigation]);
